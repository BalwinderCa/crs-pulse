...
CRS Pulse is a local-first mobile app. Your CRS profile data stays on your device. We do not operate user accounts.
...
Local data persists until you uninstall the app or use Reset in Settings. Push tokens are removed when you disable notifications or revoke via the worker API.
